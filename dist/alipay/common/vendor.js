...
var todos = ['preloadPage', 'unPreloadPage', 'loadSubPackage' // 'getRecorderManager',
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"","VUE_APP_PLATFORM":"mp-alipay","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
function initChildVues(mpInstance) {
  ...
  mpInstance._$childVues && mpInstance._$childVues.forEach(function (_ref8) {
    var vuePid = _ref8.vuePid,
        vueOptions = _ref8.vueOptions,
        VueComponent = _ref8.VueComponent,
        childMPInstance = _ref8.mpInstance;
    // 父子关系
...
function handleRef(ref) {
  ...
  if (ref.props['data-com-type'] === 'wx') {
    var eventProps = {};
    var refProps = ref.props; // 初始化支付宝小程序组件事件
    ...
    Object.keys(refProps).forEach(function (key) {
      ...
      if (res && typeof handler === 'function' && handler.name === 'bound handleEvent') {
        ...
        refProps[key] = eventProps[key] = function () {
          ...
          props[key] = handler; // 由于支付宝事件可能包含多个参数，不使用微信小程序事件格式
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(uni) {/* harmony import */ var _libs_mixin_mixin_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/mixin/mixin.js */ 12);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(uni) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MeScroll; });
/* mescroll
 * version 1.3.7
 * 2021-04-13 wenju
...
/* harmony default export */ __webpack_exports__["default"] = (GlobalOption);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(uni) {// 国际化工具类
const mescrollI18n = {
	// 默认语言
	def: "zh",
	// 获取当前语言类型
...
/* harmony default export */ __webpack_exports__["default"] = (mescrollI18n);
...
/* harmony default export */ __webpack_exports__["default"] = (WxsMixin);
