...
var MescrollBody = function MescrollBody() {
  Promise.all(/*! require.ensure | node-modules/mescroll-uni/mescroll-body */[__webpack_require__.e("common/vendor"), __webpack_require__.e("node-modules/mescroll-uni/mescroll-body")]).then((function () {
    return resolve(__webpack_require__(/*! mescroll-uni/mescroll-body.vue */ 49));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};

var MescrollUni = function MescrollUni() {
  Promise.all(/*! require.ensure | node-modules/mescroll-uni/mescroll-uni */[__webpack_require__.e("common/vendor"), __webpack_require__.e("node-modules/mescroll-uni/mescroll-uni")]).then((function () {
    return resolve(__webpack_require__(/*! mescroll-uni/mescroll-uni.vue */ 60));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};

_vue.default.component('mescroll-body', MescrollBody);

_vue.default.component('mescroll-uni', MescrollUni); //uView引入


_vue.default.use(_uviewUi.default); //阻止启动生产消息
